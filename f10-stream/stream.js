...
class ExecutableStream extends Stream {
    [Symbol.asyncIterator]() {
        return this.main();
    }
}
exports.ExecutableStream = ExecutableStream;
class IterableStream extends ExecutableStream {
    constructor(fn) {
        super();
        this.fn = fn;
    }
...
exports.Seq = Seq;
class SeqStream extends Stream {
    /**
...
class WriteStream extends SeqStream {
...
function writeStream(distinct = true, size = -1, replay = 1) {
    return new WriteStream(distinct, size, replay);
}
exports.writeStream = writeStream;
class SharedStream extends SeqStream {
...
exports.SharedStream = SharedStream;
